...
| Tools used | Python, CSV, Power BI, HTML, CSS, JavaScript, SVG, GitHub Pages |
| Main deliverable | Static dashboard, Power BI dashboard file, KPI cards, channel scorecard, trend chart, campaign matrix, video funnel, objective mix, and campaign table |
